...
class Script(scripts.Script):
    ...
    # create_ui_cfg = ui.create_ui_cfg
    ...
    #
    # create_ui_hr_prompt_mode = ui.create_ui_hr_prompt_mode
    ...
    #
    # create_hr_seed_ui = ui.create_hr_seed_ui
    ...
    def setup(self, p, *args):
        ...
        # p.prompt, p.hr_prompt = hr_prompt_mode.hires_prompt_mode_functions.get(args[1], hr_prompt_mode.hires_prompt_mode_default)(p.prompt, p.hr_prompt)
        # p.negative_prompt, p.hr_negative_prompt = hr_prompt_mode.hires_prompt_mode_functions.get(args[2], hr_prompt_mode.hires_prompt_mode_default)(p.negative_prompt, p.hr_negative_prompt)
    ...
    def process(self, p, *args):
        ...
        # p.sample_hr_pass = hr_batch_seed.sample_hr_pass_hijack(self, p, p.sample_hr_pass)
        #
        # # p.sample = self.sample_hijack(p, p.sample)
        # p.sample = hr_batch_seed.sample_hijack(self, p, p.sample)
